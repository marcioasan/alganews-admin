        ...
        <Col lg={24}>
          <Tabs defaultActiveKey={'personal'}>
            ...
            <TabPane key={'bankAccount'} tab={'Dados bancários'}>
              ...
              <Row gutter={24}>
                <Col lg={8}>
                  <Form.Item label={'Instituição'} name={['bankAccount', 'bankCode']}>
                ...
                <Col lg={8}>
                  <Form.Item label={'Conta sem dígito'} name={['bankAccount', 'accountNumber']}>
                ...
                <Col lg={8}>
                  <Form.Item label={'Tipo de conta'} name={['bankAccount', 'type']}>
